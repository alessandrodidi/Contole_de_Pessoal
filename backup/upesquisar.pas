...
begin
  ...
  if sqlqPesquisa.Fields.Fields[0].Text = EmptyStr then
    begin
      Application.MessageBox(PChar('Selecione um registro para utilizar'), 'Aviso', MB_ICONEXCLAMATION + MB_OK);
      Exit;
    end;
    ...
    'Usuários':
      ...
      begin
        Application.MessageBox(PChar('Não foram encontrados parâmetros para o retorno da pesquisa em '''+RefConsulta+''''+#13
                               ...
                               +'- Entre em contato com o administrador do sistema para reportar o problema'),'Aviso', MB_ICONEXCLAMATION + MB_OK);
        Abort;
      end;
  end;
  Self.Close;
    ...
    begin
      if E.ClassName <> 'EAbort' then
        begin
          Application.MessageBox(PChar('Erro ao utilizar o registro'+#13+#13+'Classe '+E.ClassName+#13+'Detalhes: '+E.Message), 'Erro', MB_ICONERROR + MB_OK);
        end;
    end;
  end;
end;
